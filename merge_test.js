...
const { mergeSortNoOpt, mergeSort, mergeSortBU, mergeSortBUOpt } = require('./merge_sort');
...
helper.testSort('Merge Sort BU', mergeSortBU, arr3);
helper.testSort('Merge Sort BU Opt', mergeSortBUOpt, arr4);
